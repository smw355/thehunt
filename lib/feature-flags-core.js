...
export const FEATURE_FLAGS = {
  ...
  MULTI_USER_AUTH: process.env.NEXT_PUBLIC_FEATURE_MULTI_USER_AUTH === 'true',

  // OAuth provider login
  OAUTH_LOGIN: process.env.NEXT_PUBLIC_FEATURE_OAUTH_LOGIN === 'true',

  // User dashboard and profiles
  USER_DASHBOARD: process.env.NEXT_PUBLIC_FEATURE_USER_DASHBOARD === 'true',

  // Personal clue libraries
  PERSONAL_LIBRARIES: process.env.NEXT_PUBLIC_FEATURE_PERSONAL_LIBRARIES === 'true',

  // Game invitations system
  GAME_INVITATIONS: process.env.NEXT_PUBLIC_FEATURE_GAME_INVITATIONS === 'true',

  // Public game marketplace (future feature)
  GAME_MARKETPLACE: process.env.NEXT_PUBLIC_FEATURE_GAME_MARKETPLACE === 'true',

  // Advanced role-based permissions
  ADVANCED_PERMISSIONS: process.env.NEXT_PUBLIC_FEATURE_ADVANCED_PERMISSIONS === 'true',

  // New user onboarding flow
  USER_ONBOARDING: process.env.NEXT_PUBLIC_FEATURE_USER_ONBOARDING === 'true',
}
